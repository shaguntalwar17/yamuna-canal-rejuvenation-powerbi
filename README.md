...
## Objectives
- Assess the water quality status of the Yamuna Canal using key ecological indicators  
- Analyze year-wise and station-wise trends across monitoring locations  
- Identify pollution hotspots and non-compliant stretches  
- Support evidence-based decision-making for canal rejuvenation efforts  

---

## Key Indicators Analyzed
- **Dissolved Oxygen (DO)** – indicator of aquatic ecosystem health  
- **Biochemical Oxygen Demand (BOD)** – measure of organic pollution and sewage load  
- **Total Coliform** – indicator of microbial contamination and public health risk  
- **pH** – supporting indicator for chemical balance  

These parameters are evaluated against **national water-quality standards** to highlight compliance gaps and critical zones.
...
Healthy rivers are foundational to environmental sustainability, public health, and economic resilience.  
By converting complex monitoring data into **clear, interpretable insights**, this project demonstrates how data analytics can contribute meaningfully to environmental protection and informed policy action.

---

## Author
**Shagun Talwar**  
Power BI | Data Analytics | Environmental & Social Impact Projects
